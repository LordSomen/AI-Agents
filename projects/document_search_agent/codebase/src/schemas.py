...
class CalculationResponse(BaseModel):
    ...
    extracted_numbers: List[float] = Field(description="List of the exact numbers extracted from the source documents")
    source_verification: str = Field(description="Brief explanation verifying that the extracted numbers accurately match the user's request")
...
class UserIntent(BaseModel):
    ...
    reasoning: str = Field(description="Explnation for the classification")
